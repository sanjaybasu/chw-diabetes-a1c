"""
Comprehensive Reanalysis: CHW Diabetes A1c Study
Addresses peer review concerns with methodological fixes:
  ...
  5. Tighter covariate balance assessment (SMD < 0.10)
...
# 0. Load data
# ============================================================
cohort = pd.read_parquet('analytic_cohort.parquet')
matched_t = pd.read_parquet('matched_treated.parquet')
matched_c = pd.read_parquet('matched_control.parquet')
...
print("Results saved to reanalysis_results.json")
