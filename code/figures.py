...
box(2.5,13,5,1.5,"Adults (>=18y) with diabetes (ICD-10 E08-E13 or HbA1c >=6.5%)\nidentified for care-team outreach\nVirginia Medicaid MCO, 2022-2025"); arrow(5,13,5,12.2)
box(2.5,10.6,5,1.6,"Identified-for-outreach diabetes cohort\nwith >=1 baseline HbA1c\n(eligible for analysis)")
side(7.7,10.7,2.1,1.4,"Treated = care team\nactivated\nControl = targeted,\nnot activated"); arrow(5,10.6,5,9.8)
side(7.7,8.7,2.1,1.6,"Excluded: no follow-up\nHbA1c 90-365 d after\nindex (addressed by\nIPCW sensitivity)"); arrow(5,9.8,5,9.0); arrow(5,9.4,7.6,9.4)
box(2.5,7.4,5,1.6,"With >=1 baseline and >=1 follow-up HbA1c\n(>=90 d after index): N = 372"); arrow(5,7.4,5,6.6)
side(7.7,6.5,2.1,1.3,"Excluded: missing\ncovariate (N=1);\nPS outside [0.05,0.95]\n(N=2)"); arrow(5,6.6,5,5.8); arrow(5,6.2,7.6,6.2)
